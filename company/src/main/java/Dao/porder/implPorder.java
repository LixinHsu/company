...
public class implPorder implements porderDao{
	...
	public static void main(String[] args) {
		/*porder p = new porder("J桌",1,1,1);
		new implPorder().add(p);*/
		
		//System.out.println(new implPorder().queryAll());
		 
		//System.out.println(new implPorder().querySum(300, 500));
		
		//System.out.println(new implPorder().queryId(7));
		
		porder p = new implPorder().queryId(9); 
		p.setDesk("I桌");
		p.setA(2);
		
		new implPorder().update(p);
		
		//new implPorder().delete(10);
